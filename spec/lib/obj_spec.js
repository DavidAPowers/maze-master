...
describe('Obj', () => {
	...
	describe('.maxProp(o)', () => {
		it('Given an with no properties, throws error', () => {
			let r1;
			let stats1 = { };
			try {r1 = Obj.maxProp(stats1);}
			catch(e) {
				expect(e).toEqual(new Error("AbilityScore.maxProp() takes an object with at least one property"));
			}		
